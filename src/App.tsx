    ...
    <>
      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500/30 selection:text-white">
        <main>
          ...
          <section id="skills" aria-label="Technical Skills" className="py-16 px-2 sm:px-3 lg:px-4 relative">
          ...
          <section id="services" aria-label="Services" className="py-16 px-2 sm:px-3 lg:px-4 relative">
